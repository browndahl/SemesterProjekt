...
const DB_USER = process.env.DB_USER || "kaehqzuq";
const DB_HOST = process.env.DB_HOST || "dumbo.db.elephantsql.com";
const DB_NAME = process.env.DB_NAME || "kaehqzuq";
const DB_PW = process.env.DB_PW || "zel-OpYqSHcrpXH0hvWKQFx55GZzn0SU";
